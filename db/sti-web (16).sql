...
-- Tiempo de generación: 15-05-2021 a las 05:05:39
...
(979, 1, 1, 32, 1, 4, 'MXL3243905', '740899500535', 'HP', 'HP ELITE 8300 SFF(80)', 'ESTACION DE TRABAJO', '2013-01-01', '789', '3 AÑOS', 'HP', 'CORE I5', '3.40 GHZ', '2GB', '500GB', NULL, NULL, 'REGISTRO NUEVO', NULL, NULL, 1, 1, 4, '2021-05-11 10:02:38'),
...
--
ALTER TABLE `ws_equipos`
  MODIFY `idEquipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1071;
...
--
ALTER TABLE `ws_integraciones`
  MODIFY `idIntegracion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
