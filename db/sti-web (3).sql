...
-- Tiempo de generación: 05-04-2021 a las 20:13:49
...
(9, 1, 'Memoria  RAM malograda', 1),
(10, 1, 'Placa madre malograda', 0),
(11, 1, 'Falta de mantenimiento', 1),
...
--
ALTER TABLE `ws_z_auditoria_mantenimientos`
  MODIFY `idAudMant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
