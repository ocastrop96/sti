...
select idMantenimiento,correlativo_Mant,date_format(fRegistroMant,'%d/%m/%Y') as fRegManto,tipEquipo,categoria,idEquip,serie,oficEquip,area,oficEquip,subarea,uResponsable,concat(nombresResp," ",apellidosResp) as responsable,logdeta,date_format(fEvalua,'%d/%m/%Y') as fEval,condInicial,fsitu.situacion as cinicial,tecEvalua,concat(nombres," ",apellido_paterno," ",apellido_materno) as tecnico,descInc,primera_eval,fInicio,fFin,tipTrabajo,tipoTrabajo,recomendaciones,estAtencion,estAte,condFinal,fsitu2.situacion as cfinal,servTerce,otros,obsOtros,sgmtoManto,estAnulado,estadoDoc from ws_mantenimientos as fmant
...
CREATE TABLE `ws_mantenimientos` (
  ...
  `diagnostico2` int(11) DEFAULT '0',
  `diagnostico3` int(11) DEFAULT '0',
  `diagnostico4` int(11) DEFAULT '0',
  `diagnostico5` int(11) DEFAULT '0',
  `diagnostico6` int(11) DEFAULT '0',
  `diagnostico7` int(11) DEFAULT '0',
  `diagnostico8` int(11) DEFAULT '0',
  ...
  `accion2` int(11) DEFAULT '0',
  `accion3` int(11) DEFAULT '0',
  `accion4` int(11) DEFAULT '0',
  `accion5` int(11) DEFAULT '0',
  `accion6` int(11) DEFAULT '0',
  `accion7` int(11) DEFAULT '0',
  `accion8` int(11) DEFAULT '0',
...
(1, 'FM-2021-00001', '2021-04-04', 1, 1, 54, 13, 18, 9, 'N° Equipo: PC_OCP || Serie N°: MXL2500TDK || Cod.Patr: 740899500413 || Marca: HP || Modelo: ELITE 8300 || Descripción: PC DE ESCRITORIO || IP: 172.16.5.100 || Procesador: CORE I7-3.40 GHZ || RAM: 12GB || Disco Duro: 1TB', 'prueba 1', 4, 24, 0, 0, 0, 0, 0, 0, 4, '2021-04-01', 'prueba 1', '2021-04-01', '2021-04-01', 1, 1, 15, 0, 0, 0, 0, 0, 0, 'prueba 1', 1, 1, 'NO', 'NO', '', 1, 1, 1, '2021-04-04 23:58:03'),
(2, 'FM-2021-00002', '2021-04-04', 5, 1, 83, 13, 16, 13, 'N° Equipo: SERV_0001 || Serie N°: SERV1 || Cod.Patr: 1177212 || Marca: SAERV || Modelo: SERV || Descripción: SERV || IP: 172.16.0.4 || Procesador: XEON-3.20 GHZ || RAM: 32GB || Disco Duro: 4TB', 'ajam', 24, 4, 7, 0, 0, 0, 0, 0, 5, '2021-04-01', 'ajam', '2021-04-01', '2021-04-01', 2, 1, 12, 15, 2, 0, 0, 0, 0, 'ajam', 2, 1, 'NO', 'SI', 'ajam', 1, 1, 1, '2021-04-05 02:23:19'),
(3, 'FM-2021-00003', '2021-04-04', 15, 2, 85, 13, 18, 9, 'N° Equipo: ESC_001 || Serie N°: ESCANOR || Cod.Patr: 1237 || Marca: ESCANER || Modelo: ESCANER || Descripción: ESNCAER || IP: ', 'ajam', 16, 0, 0, 0, 0, 0, 0, 0, 6, '2021-04-01', 'ajam', '2021-04-01', '2021-04-02', 1, 20, 0, 0, 0, 0, 0, 0, 0, 'ajam', 1, 1, 'NO', 'NO', '', 1, 3, 1, '2021-04-05 02:24:53'),
(4, 'FM-2021-00004', '2021-04-04', 2, 2, 58, 13, 18, 9, 'N° Equipo: SW_00001 || Serie N°: SWITCH123 || Cod.Patr: 151518484546 || Marca: HP || Modelo: ARUBA || Descripción: SWITCH ADMINISTRABLE || IP: ', 'AJAM', 15, 0, 0, 0, 0, 0, 0, 0, 5, '2021-04-01', 'ajam', '2021-04-01', '2021-04-02', 3, 19, 0, 0, 0, 0, 0, 0, 0, 'ajam', 2, 1, 'NO', 'SI', 'SE RECOMIENDA COMPRAR NUEVO EQUIPO', 1, 2, 1, '2021-04-05 02:26:22'),
(5, 'FM-2021-00005', '2021-04-04', 3, 2, 59, 13, 18, 9, 'N° Equipo: IMP_0001 || Serie N°: BRBSXBT8XZ || Cod.Patr: 740841000067 || Marca: HP || Modelo: M426FDW || Descripción: HP LASERJET LASERJET PRO || IP: 172.16.5.210', 'Se verifica que impresora no imprime', 31, 6, 0, 0, 0, 0, 0, 0, 6, '2021-04-01', 'Se revisa cableado y entradas de la impresora', '2021-04-02', '2021-04-02', 1, 3, 20, 0, 0, 0, 0, 0, 0, 'Se recomienda mantenimientos periódicos y limpieza', 1, 1, 'NO', 'NO', '', 1, 3, 1, '2021-04-05 02:30:34'),
(6, 'FM-2021-00006', '2021-04-04', 4, 2, 90, 13, 18, 9, 'N° Equipo: LAP_0555 || Serie N°: LENOVO12 || Cod.Patr: 17171828 || Marca: LENOVO || Modelo: LEVONO || Descripción: LENOVO || IP: 172.16.8.100 || Procesador: CORE I3-3.20GHZ || RAM: 8GB || Disco Duro: 1TB', 'AÑO NUEVO', 4, 24, 7, 0, 0, 0, 0, 0, 4, '2021-04-02', 'AÑO NUEVO °', '2021-04-02', '2021-04-02', 2, 15, 2, 12, 1, 17, 13, 0, 0, 'AÑO NUEVO', 1, 1, 'NO', 'NO', '', 1, 1, 1, '2021-04-05 03:10:07'),
(7, 'FM-2021-00007', '2021-04-05', 10, 2, 56, 13, 18, 9, 'Serie N°: 6CM2480JSF || Cod.Patr: 740880370017 || Marca: HP || Modelo: LV2311 || Descripción: MONITOR 24 PLGDAS', 'Se verifica que monitor no muestra señal alguna', 16, 0, 0, 0, 0, 0, 0, 0, 4, '2021-04-05', 'Se revisas la entradas del equipo', '2021-04-05', '2021-04-05', 2, 20, 0, 0, 0, 0, 0, 0, 0, 'Se recomienda la compra de nuevo monitor', 1, 1, 'NO', 'NO', '', 1, 3, 1, '2021-04-05 10:39:08'),
(8, 'FM-2021-00008', '2021-04-05', 6, 1, 75, 10, 24, 12, 'N° Equipo: RT_001 || Serie N°: ARUBA1 || Cod.Patr: 1122 || Marca: ARUBA || Modelo: ARUBA2323 || Descripción: ASAS || IP: ', 'El equipo no enciende ni transmite señal', 15, 5, 12, 0, 0, 0, 0, 0, 4, '2021-04-05', 'Se verifica que el equipo presenta problemas al encender', '2021-04-05', '2021-04-05', 1, 19, 25, 0, 0, 0, 0, 0, 0, 'Se recomienda mantenimiento periódico o en su defecto compra de nuevo equipo', 1, 1, 'NO', 'SI', 'Se entrega equipo funcionando correctamente', 1, 2, 1, '2021-04-05 10:40:16'),
