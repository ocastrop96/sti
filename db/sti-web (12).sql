...
-- Tiempo de generación: 05-05-2021 a las 18:34:38
...
(11, 2, 'DIRECCION ADJUNTA', '2021-05-04 17:47:55'),
...
CREATE TABLE `ws_usuarios` (
  ...
  `apellido_paterno` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `apellido_materno` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `cuenta` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
(2, 2, '40195996', 'Nohemí', 'Rosas', 'Sanchez', 'rosasmn', '$2a$07$usesomesillystringforeoRNSqF5ebwOJ.HFIcVhNJ65bww3hpNi', '2021-03-11 15:46:33', 0, 0),
...
--
ALTER TABLE `ws_servicios`
  MODIFY `id_subarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
