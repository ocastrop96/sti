...
-- Tiempo de generación: 30-05-2021 a las 01:07:41
...
(1501, 1, 1, 5, 6, 29, 'ML3232488    ', '740899500506', 'HP', 'HP ELITE 8300 SFF (20)', 'ESTACION DE TRABAJO', '2013-01-01', '789', '3 AÑOS', 'HP', 'CORE I7', '3.4 GHZ', '4 GB', '1 TB', NULL, NULL, 'REGISTRO NUEVO', NULL, NULL, 1, 1, 4, '2021-05-19 10:13:26'),
...
--
ALTER TABLE `ws_acciones`
  MODIFY `idAccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `ws_equipos`
  MODIFY `idEquipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1597;
...
--
ALTER TABLE `ws_integraciones`
  MODIFY `idIntegracion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `ws_servicios`
  MODIFY `id_subarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
