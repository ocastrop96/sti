          ...
          <div class="row">
            ...
            <div class="col-12 col-md-3">
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" name="serieEQ" id="serieEQ">
...
<div id="modal-editar-mantenimiento" class="modal fade" role="dialog" aria-modal="true" style="padding-right: 17px;">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form action="" role="form" id="formEdtMant" method="post" class="frmManto1">
        <div class="modal-header text-center" style="background: #6c757d; color: white">
