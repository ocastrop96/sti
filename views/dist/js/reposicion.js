// Tabla general
$(".tablaReposicion").DataTable({
    "ajax": "util/datatable-reposiciones.php",
    "deferRender": true,
    "retrieve": true,
    "processing": true,
    "paging": true,
...
$("#modal-editar-reposicion").on('hidden.bs.modal', function (e) {
...
$("#btnRegRepo").on("click", function () {
    $("#formRegRepo").validate({
        rules: {
            tipEquipo: {
                valueNotEquals: "0",
                required: true,
...
$("#btnRegRepo").click(function (e) {
    var form1 = $("#formRegRepo");
...
$("#btnEdtRepo").on("click", function () {
    $("#formEdtRepo").validate({
        rules: {
            edtipEquipo: {
                valueNotEquals: "0",
                required: true,
...
$("#btnEdtRepo").click(function (e) {
    var form1 = $("#formEdtRepo");
    validacion = form1.valid();
    if (validacion == true) {
        let timerInterval;
        Swal.fire({
...
$(".tablaReposicion").on("click", ".btnEditarRepo", function () {
    var idReposicion = $(this).attr("idReposicion");
    var datos = new FormData();
    datos.append("idReposicion", idReposicion);
    $.ajax({
        url: "lib/ajaxReposiciones.php",
        method: "POST",
        data: datos,
...
// Editar Mantenimiento
$(".tablaReposicion").on("click", ".btnAnularReposicion", function () {
    var idReposicion = $(this).attr("idReposicion");
    var idUsuario = $("#idOculto").val();

    Swal.fire({
        title: '¿Está seguro de anular la solicitud de reposición?',
        ...
        confirmButtonText: '¡Sí, anular solicitud!'
        ...
        if (result.value) {
            ...
            window.location = "index.php?ruta=reposicion&idReposicion=" + idReposicion + "&idUsuario=" + idUsuario;
        }
    });
});
$(".tablaReposicion").on("click", ".btnImprimirFichaRepo", function () {
    var idReposicion = $(this).attr("idReposicion");
    var idTipo = $(this).attr("tipoEquipo");
    window.open("reports/ficha-reposicion.php?idReposicion=" + idReposicion + "&idTipo=" + idTipo, "_blank");
});
