...
class ModeloReposiciones
{
    static public function mdlListarFichasRepo($item, $valor)
    {
        if ($item != null) {
            ...
            $stmt = Conexion::conectar()->prepare("CALL LISTAR_FICHAS_REPO()");
            $stmt->execute();
    ...
    static public function mdlListarDatosEqOtrosRepo($dato)
    {
    ...
    static public function mdlListarDatosEqComputoRepo($dato)
    {
    ...
    static public function mdlListarDatosEqRedesRepo($dato)
    {
    ...
    static public function mdlListarDatosEqImpRepo($dato)
    {
    ...
    static public function mdlRegistrarReposicion($datos)
    {
        ...
        $stmt->bindParam(":fRegistroRepo", $datos["fRegistroRepo"], PDO::PARAM_STR);
    ...
    static public function mdlAnularReposicion($datos)
    {
        $stmt = Conexion::conectar()->prepare("CALL ANULAR_REPOSICION(:idReposicion)");
        $stmt->bindParam(":idReposicion", $datos, PDO::PARAM_STR);
        $stmt->execute();
        if ($stmt->execute()) {
            return "ok";
        } else {
    ...
    static public function mdlRegistroAuditoriaRepo($datos)
    {
        $stmt = Conexion::conectar()->prepare("CALL Z_REG_AUDITORIAREPO(:idDoc,:usExec,:accExec,:fecha_audi)");
    ...
    static public function mdlListarMantoComputoRepo($dato)
    {
        $stmt = Conexion::conectar()->prepare("CALL LISTAR_MANTO_COMPUS_REPO(:idReposicion)");
        $stmt->bindParam(":idReposicion", $dato, PDO::PARAM_STR);
        $stmt->execute();
        return $stmt->fetch();
        $stmt->close();
        $stmt = null;
    ...
    static public function mdlListarMantoRedesRepo($dato)
    {
        $stmt = Conexion::conectar()->prepare("CALL LISTAR_MANTO_REDES_REPO(:idReposicion)");
        $stmt->bindParam(":idReposicion", $dato, PDO::PARAM_STR);
        $stmt->execute();
        return $stmt->fetch();
        $stmt->close();
    ...
    static public function mdlListarMantoImpreRepo($dato)
    {
        $stmt = Conexion::conectar()->prepare("CALL LISTAR_MANTO_IMPRE_PERI_REPO(:idReposicion)");
        $stmt->bindParam(":idReposicion", $dato, PDO::PARAM_STR);
        $stmt->execute();
        return $stmt->fetch();
        $stmt->close();
    ...
    static public function mdlListarMantoOtrosRepo($dato)
    {
        $stmt = Conexion::conectar()->prepare("CALL LISTAR_MANTO_OTROS_REPO(:idReposicion)");
        $stmt->bindParam(":idReposicion", $dato, PDO::PARAM_STR);
        $stmt->execute();
        return $stmt->fetch();
        $stmt->close();
