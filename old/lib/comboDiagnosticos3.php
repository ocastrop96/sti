...
if (isset($_POST["sgmt"]) && !empty($_POST["existe"]) && !empty($_POST["existe2"]) && !empty($_POST["existe3"])) {
    $qstmt = $db->query("CALL LISTA_SDIAG3(" . $_POST["sgmt"] . "," . $_POST["existe"] . "," . $_POST["existe2"] . "," . $_POST["existe3"] . ")");
