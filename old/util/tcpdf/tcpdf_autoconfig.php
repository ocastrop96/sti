...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'logo-hnseb.png')) {
		$tcpdf_header_logo = 'logo-hnseb.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'OFICINA DE GESTIÓN DE LA CALIDAD-HNSEB');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'OFICINA DE GESTIÓN DE LA CALIDAD-HNSEB');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Reclamo en Salud Virtual');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by: Oficina de Estadística e Informática-HNSEB");
}
